...
fuselage = System("Fuselage", 2200*(1/0.9), 0.45, system_estimates, z_loc=3.2)

landing_gear = System("Landing Gear", 1211.54*(1/0.9), 0.4, system_estimates, z_loc=0.5)
...
VT = System("VT", 412*(1/0.9), 0.88, system_estimates, z_loc=8.1)

HT = System("HT", 299*(1/0.9), 0.92, system_estimates, z_loc=3.2)
